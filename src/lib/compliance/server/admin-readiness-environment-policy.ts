...
/** Temporary diagnostic facts only; no origin or environment value is returned. */
...
/**
 * Produces only redacted booleans and a closed category set for the temporary
 * production smoke diagnostic. Raw origins, keys, and environment values are
